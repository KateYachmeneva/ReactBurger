...
import { TIngredientData,TFormData,TFullUserData,ILoginUserData,TUserData,TTokenData } from "../utils/types";
...
export const loginUserDataApi = ({ email, password}:ILoginUserData): Promise<TTokenData> => {
